...
struct Human: Identifiable {
    ...
    var comment: [[QuotationСharacteristic : String]]? = nil
...
extension Human {
    static let sample1 = [
        Human(
            ...
            comment: [[QuotationСharacteristic.selfProvement: "Каждый хочет изменить человечество, но никто не задумывается о том, как изменить себя."]]
        )
    ]
}
...
let arrayWithAutors = [
    Human(
        ...
        biography: "один из наиболее известных русских писателей и мыслителей, один из величайших писателей-романистов мира. Участник обороны Севастополя. Просветитель, публицист, религиозный мыслитель, его авторитетное мнение послужило причиной возникновения нового религиозно-нравственного течения — толстовства. За свои взгляды был отлучён от церкви. Член-корреспондент Императорской Академии наук 1873 года, почётный академик по разряду изящной словесности 1900 года. Был номинирован на Нобелевскую премию по литературе 1902, 1903, 1904, 1905 годы. Впоследствии отказался от дальнейших номинаций. Классик мировой литературы. Писатель, ещё при жизни признанный главой русской литературы. Творчество Льва Толстого ознаменовало новый этап в русском и мировом реализме, выступив мостом между классическим романом XIX века и литературой XX века. Лев Толстой оказал сильное влияние на эволюцию европейского гуманизма, а также на развитие реалистических традиций в мировой литературе. Произведения Льва Толстого многократно экранизировались и инсценировались; его пьесы ставились на сценах всего мира. Лев Толстой был самым издаваемым в СССР писателем за 1918—1986 годы: общий тираж 3199 изданий составил 436,261 млн экземпляров.",
        comment: [
            [QuotationСharacteristic.selfProvement: "Каждый хочет изменить человечество, но никто не задумывается о том, как изменить себя."],
            [QuotationСharacteristic.selfProvement: "Красота, спасёт мир"],
            [QuotationСharacteristic.selfProvement: "Терпенье и труд, всё перетрут"]
        ]
    ),
    Human(
        name: "Платон",
        ...
        comment: [
            [QuotationСharacteristic.selfProvement: "Воспитание есть усвоение хороших привычек."],
            [QuotationСharacteristic.selfProvement: "Стараясь о счастье других, мы находим свое собственное."],
            [QuotationСharacteristic.selfProvement: "Наилучшее воспитание молодых людей, да и самих себя, заключается не во внушениях, а в явном для всех осуществлении в собственной жизни того, что внушается другому."]
        ]
    ),
    Human(
        name: "Сократ",
        ...
        comment: [
            [QuotationСharacteristic.selfProvement: "Кто хочет — ищет способ, кто не хочет — ищет причину"],
            [QuotationСharacteristic.selfProvement: "Жизнь — искусство, для овладения которым необходимо знание, знание цели, к которой следует стремиться."],
            [QuotationСharacteristic.selfProvement: "Не делайте другим того, что не нравится вам, когда это совершается по отношению к вам."]
        ]
    )
]
